...
export const ExtrapolacionCasosCovid =({DataCovid})=>{
    ...
    const extrapolacion =()=>{
        ...
        let x1 = new Date(newCasosCovid[logitudArreglo-2].Date).getDate()+1; //Devuelve la penultima fecha donde existen registros 
        let x2 = new Date(newCasosCovid[logitudArreglo-1].Date).getDate()+1; //Devuelve el ultimo dia con registros de casos covid
